...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="{{ asset('assets/images/logo_figure.jpg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">TNWatch</span>
        </a>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            ...
                            <p>
                                ...
                                @if($issue->count()>0)
                                    <span class="badge badge-info right">{{$issue->count()}}</span>
                                @endif
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
